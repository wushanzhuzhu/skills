...
from licensemake1 import LicenseService
...
def import_license():
    ...
    if request.method == 'POST':
        data = request.get_json()
        print("post data", data)
        print(data["clusterId"],data["archType"])
        licensetxt = LicenseService.get_permit_info(data["clusterId"], data["archType"], 100,30,100,100,100,"2026-12-31")
