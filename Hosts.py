...
class Hosts:
    ...
    def getStorsbyDiskType(self):
       ...
       [{"stackname": "basic-replica2", "zoneId": "xxxx-xxxx-xxxx-xxxx", "diskType": "xxxx-xxxx-xxxx-xxxx", "storageBackend": "xxxx-xxxx-xxxx-xxxx", "storageManageId": "xxxx-xxxx-xxxx-xxxx"},......]
        ...
        logger.info("getStorsbyDiskType listStorage rs:", rs.json().get('data', []))
        ...
        logger.info("getStorsbyDiskType stors_rs:", stors_rs)
        ...
        logger.info("getStorsbyDiskType listDiskType rs:", rs2.json().get('data', []))
        ...
        logger.info("getStorsbyDiskType final stors_rs:", stors_rs)
